...
![Öffnen der Einstellungen im ORS Tool](figures/ORS_Einstellungen.png){#fig-ORS-einstellung width=25%}
...
![Einfügen des API Keys](figures/ORS_key.png){#fig-ORS-key width=25%}
...
![ Beachten Sie, dass Sie mit + eine ganze Route setzen müssen und nicht einzelne Punkte.](figures/ORS_Punkte.png){#fig-ORS-route width=25%}
