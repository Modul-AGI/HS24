...
2. Der Code wird in sogenannten *Code Chunks* geschrieben. Eine neue Zelle fügt ihr ein, indem ihr `Ctrl+Shift+I` drückt. Falls in der eckigen Klammer nicht *pyhton* stehen sollte, müsst ihr das in diesem Fall anpassen.
...
Ändere zum Schluss den Namen des HTML Files auf `index.html`. Mit Rechtsklick auf das File kann über `Download` das HTML-File heruntergeladen werden.
