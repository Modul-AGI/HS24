...
Im Modul Angewandte Geoinformatik benutzen wir Python. Mit der Installation von ArcGIS sollte Python bereits installiert sein. Es muss also lediglich getestet werden, ob dies auch wie erwartet funktioniert. Bitte führt die Instruktionen unter dem Punkt [Mit ArcGIS Installation](#sec-mit-arcgis) durch.
...
2. Folgender Befehl eingeben: 
    ...
    python3 --version
    ```
3. Wenn der obige Befehl eine Fehlermeldung verursacht, bitte mit der Anleitung [Ohne ArcGIS Installation](#sec-ohne-arcgis) weiterfahren.
