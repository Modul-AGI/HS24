...
Spalten bestimmt werden. Mit dem kleinen Stiftsymbol können Sie die Felder anpassen bzw. zuweisen. Das gleiche gilt für das Feld "id_erfasser" bzw. "id_erfasse" (siehe @fig-db2-uebung8-2).
